...
let cat1 = new Cat('Fluffy', 10, 'White');
...
let phone1 = new Phone('Apple', 'iPhone', 128, 'Space Grey', 1000)
let phone2 = new Phone('Samsung', 'Galaxy S21', 256, 'Silver', 1200)
let phone3 = new Phone('Evo', 'Android', 128, 'Red', 800)
...
class Vehicle {
  ...
  move(miles) {
    let newMileage = (miles + this.mileage)
...
let myFirstVehicle = new Vehicle(5, 'black', 79000);

myFirstVehicle.move(111);
...
let myFirstMotorcycle = new Motorcycle(2, 'Blue', 10000, 'Honda', true);
...
let myFirstBoat = new Boat(8, 'White', 0, 'S.S. Tipsy', 'Pontoon', false)
